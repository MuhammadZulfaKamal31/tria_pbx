        ...
        >
          ...
          <div class="flex flex-col justify-center text-center items-center">
            ...
            <p class="font-medium">
              ...
              kehidupan sehari-hari, dunia kerja (karir), dan dunia
              kewirausahaan karena tidak kompeten
            </p>
          </div>
          <!-- 3 -->
          <div class="flex flex-col justify-center text-center items-center">
            ...
            <p class="font-medium">
              Masyarakat yang menempuh jalur Pendidikan non-formal tidak
              memiliki kesempatan bersosialisasi dengan sebaya secara luring
            </p>
          </div>
          <!-- 4 -->
          <div class="flex flex-col justify-center text-center items-center">
          ...
          >
            ...
            <div class="flex flex-col justify-center text-center items-center">
              ...
              <p class="font-medium">
                ...
                tidak hanya mengerti konsep dan teori saja, tetapi juga
                bagaimana mengeksekusi dan mempraktekannya secara detil dan
                mendalam.
              </p>
            </div>
            <!-- 3 -->
            <div class="flex flex-col justify-center text-center items-center">
              ...
              <div class="w-full">
                ...
                <p class="font-medium">
                  Di era Society 5.0, dimana manusia dan masyarakatnya adalah
                  tema utama dari perkembangan zaman ini, interaksi menjadi hal
                  yang terpenting dalam proses pembelajaran. Anak bertumbuh
                  dengan baik, berawal dari interaksi yang sehat dengan
                  pembimbingnya.
                </p>
              </div>
            </div>
            ...
            <div class="flex flex-col justify-center text-center items-center">
              ...
              <h1 class="font-semibold text-xl">Metode Pembelajaran</h1>
              <p class="font-medium">
                Pembelajaran yang tidak seimbang. Pada satu sisi terlalu
                berfokus kepada anak saja. Pada sisi lain, hanya mengikuti
                kehendak orang tua saja.
              </p>
            </div>
          </div>
        </div>
